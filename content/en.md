  ...
  - taxonomy: News & Media
    ...
    links:
      ...
      - title: Signal Fire
        ...
        description: No longer updated.
      - title: benderamerah
        url: https://benderamerahmy.wordpress.com/tentang-kami/
        description: A blog dedicated to publishing Malay translations, aiming to disseminate international proletarian ideology—Marxism-Leninism and Maoist—to the general public in Malaysia, with a particular focus on Maoist
      - title: 반란
        url: https://uprising.kr/about/
        description: 'Journal of Korean Marxist-Leninist-Maoist '
      - title: Red flag
        url: https://chervoneznamya.wordpress.com/
        description: Publication of the Revolutionary Communist Party of Ukraine
      - title: FAJAR MERAH
        url: https://fajarmerahmedia.wordpress.com/
        description: Publications of the Indonesian Maoists
  - taxonomy: Databases
    icon: fa-star
    links:
